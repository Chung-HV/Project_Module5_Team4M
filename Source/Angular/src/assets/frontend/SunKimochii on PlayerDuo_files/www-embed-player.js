...
N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.aa;N.prototype.publish=N.prototype.U;N.prototype.clear=N.prototype.clear;z("ytPubsubPubsubInstance",Fg,void 0);z("ytPubsubPubsubTopicToKeys",Hg,void 0);z("ytPubsubPubsubIsSynchronous",Ig,void 0);z("ytPubsubPubsubSubscribedKeys",Gg,void 0);var Pg=window,Q=Pg.ytcsi&&Pg.ytcsi.now?Pg.ytcsi.now:Pg.performance&&Pg.performance.timing&&Pg.performance.now&&Pg.performance.timing.navigationStart?function(){return Pg.performance.timing.navigationStart+Pg.performance.now()}:function(){return(new Date).getTime()};var Qg=tf("initial_gel_batch_timeout",2E3),Rg=Math.pow(2,16)-1,Sg=null,Tg=0,Ug=void 0,Vg=0,Wg=0,Xg=0,Yg=!0,Zg=y.ytLoggingTransportGELQueue_||new Map;z("ytLoggingTransportGELQueue_",Zg,void 0);var $g=y.ytLoggingTransportTokensToCttTargetIds_||{};z("ytLoggingTransportTokensToCttTargetIds_",$g,void 0);
